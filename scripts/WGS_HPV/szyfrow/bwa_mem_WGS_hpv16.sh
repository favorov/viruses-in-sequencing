...
reference="/home/favorov/reference/NCBI-HPV/hpv16/bwa_index/HPV16.fa"
outputdir="/home/favorov/Dasha/JHU-WGS-HPV/hpv16-bams/"
...
for sample in ${list[@]}
	...
	for wgs1 in "${wgsfiles[@]}"
		...
		qsub  -o $outputdir -e $outputdir -v wgs1=$wgs1,iter=$iter,outputdir=$outputdir,reference=$reference,sample=$sample run_bwa_mem_WGS_hpv16.sh	
		((iter++))
		done
	done
