...
hpv16<-sapply(list.of.full.counters,function(vec) ifelse(is.na(vec['hpv16']),0,vec['hpv16']))
hpv33<-sapply(list.of.full.counters,function(vec) ifelse(is.na(vec['hpv33']),0,vec['hpv33']))
...
counts<-rbind(counts,hpv16,hpv33,hpv35,hhv4,hhv4t1)
